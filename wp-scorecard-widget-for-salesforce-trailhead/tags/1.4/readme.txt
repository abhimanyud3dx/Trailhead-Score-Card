...
Plugin that gives you the ability to add a Widget in which you can see your Salesforce Trailhead Badges count, points and trails score in the realtime. A must plugin to have for salesforce bloggers. Setup by just SSSSsetting the trailhead Id from the Trailhead Profile.
