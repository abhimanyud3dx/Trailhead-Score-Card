...
This is a simple plugin that give you the ability to add a Widget in which see your Salesforce Trailhead Badges count, points and trails score in the realtime.  This is a must plugin to have for salesforce bloggers. This plugin will enable a widget that you can setup just by setting the trailhead Id from the Trailhead Profile.
